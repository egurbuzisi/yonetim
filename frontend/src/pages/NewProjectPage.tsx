...
import { ArrowLeft, Camera, Image, Save, X, Check, Tag, Search } from 'lucide-react';
...
export default function NewProjectPage() {
  ...
  const [status, setStatus] = useState('dusunuluyor');
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="bg-blue-900 text-white px-4 py-3 flex items-center justify-between sticky top-0 z-10">
        ...
        <h1 className="text-lg font-semibold">Yeni Proje</h1>
      ...
      <form onSubmit={handleSubmit} className="p-4 space-y-4">
        ...
        <div>
          ...
          <p className="text-xs text-gray-500 mt-1">Sadece seçilen kişiler ve oluşturan görebilir</p>
        </div>

        {/* Submit Button */}
        <button
          type="submit"
          className="w-full bg-blue-600 text-white py-4 rounded-lg font-medium hover:bg-blue-700 transition-colors mt-6"
        >
          Proje Oluştur
        </button>
      </form>
